<template>
    <div>
      ...
      <div id="mypart1" v-show="showpart1">
        <h1> 企业测评介绍</h1>
          <p id="testnormal">
            企业测试:最主要就是看我们的职业定位。职业定位是自我定位和社会定位的统一，只有在了解自己和职业的基础上才能够给自己做准确定位。
            检视个人特质
        ...
        <p id="testnormal2">
          每企业群都需要定位，其目的是保证自己持续地发展。但是各个群体定位的重点不同：定位重点在于澄清自己有什么。过高或者过低估价自己，过于看重自己的文凭，或者看重自己的成绩，有的过于低估自己身上的潜质，所以，既需要认真地分析自己，又需要多了解社会需求，以求定位准确。在大多数情况下，正确的思路是，做你应该做的事，而不是做你喜欢做的事。
          测试依据编辑
          1.职业能力倾向具有相对广泛性
      ...
      <div id="mypart3" v-show="showpart3">
        <h1> 【企业测评报告简介】 </h1>
        <p id="testnorma3">
          为了使企业能更好的使用本测评报告，请你仔细阅读本测评报告的所有内容。 本报告将为你 介绍在此次报告中提到的理论基础和相关名词以及为你解读属于你的测评报告结果。 通过 本测评，可以相对准确地帮助你了解你自身的性格特征与职业选择之间的匹配关系， 同时 也为你选择未来的职业发展方向提供一定的指导和参考依据。 ■ 本测试主要以霍兰德职业兴趣理论（Holland Vocational Interest Theory）为基础， 结合每种职业兴趣类型的性格特点，并根据中国职业划分的基本类型设计而成。 ■ 本测试主要从你的活动倾向性、你的职业能力评估以及你的职业性格倾向性这三个方面 来对你的职业兴趣类型进行测评。这三个方面的内容是相辅相成的， 当你想要从事某一职 业时，你不仅需要结合自身过去从事某活动的兴趣程度，也要考虑你是否已经具备了从事这 一职业的能力。 同时，职业的发展也不能忽视自身的职业性格倾向性，因此在本测试中有 一部分测试题是对你的职业性格进行测试。 通过这三个方面的测试，将有助于为你提供更 为准确的测评结果。
        </p>
        <p>{{baogao}}</p>
        <a-button block type="primary" :size="size" @click="myanswersubmit">点击这里打印报告</a-button>
      </div>
  ...
  export default {
    ...
    data(){
      ...
      return {
        ...
        reqmsg2:[],
        baogao:"【职业性格优势】 ■集中精力的专注于自己的某一项工作的完成；一丝不苟、认真专注地对待要解决 的问题；高度的责任心，信守诺言，值得信任； ■能灵活地适应新情况，具有随机应变的能力；独立自主、探险精神、创造意识以 及克服困难的勇气；具有强烈的好奇心，具有快速搜索需要的信息的能力； ■尊重别人的地位和能力；讲求实效的工作态度，办事方法现实可行； 【职业性格劣势】 ■可能过于理智而失去了享受生活的乐趣；不喜变动，对于经常变化的事物感到不 安；过于注重细节而忽略了整体以及对事物的长远影响； ■不擅长把复杂的思想和问题用简明的形式表现出来；对待他人的要求和对待自己 的要求一样高；不轻易给自己正面、肯定的评价； ■不太愿意尝试、接受新的和未经考验的观点和想法；在感到压力比较大时，可能 难以按照以往的沉着和冷静来进行应对； 北京易普斯咨询有限责任公司拥有本报告所有版权，未经易普斯咨询书面许可，不得复制、传播职业兴趣测评结果报告 【适合的工作环境】 ■适合于能够依照过去的经验和规律来解决问题；需要更多独立的空间，专心的去 解决问题或完成整个项目； ■适合于需要运用智力、能够独立工作的工作环境，偶尔有一些冒险和变动是你能 够接受的； ■适合于具有结构的、有系统、有条理的工作环境；",
       url: {
